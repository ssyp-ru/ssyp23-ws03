extends "res://entities/Herbivore/Herbivore.gd"
...
func init():
	...
	match randi_range(1, 4):
		...
		4:
			animation = "run_white"
			edible_group = "first_consuments" if not randi_range(0, 3) else "fruits"
...
func give_birth_animal(animal,children):
	...
	for i in range(round(children) as int):
		...
		var instancedObject = load("res://entities/Rabbit/Rabbit.tscn")
